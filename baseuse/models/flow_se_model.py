...
import torch
import torchaudio
from baseuse.models.bsrnn_flowse import BSRNN
...
from baseuse.models.odes import FLOWMATCHING
from espnet2.enh.encoder.stft_encoder import STFTEncoder
from espnet2.enh.decoder.stft_decoder import STFTDecoder

from baseuse.sampling import  get_white_box_solver
...
class FlowSEModel(L.LightningModule):
    ...
    def speech_to_feature(self, speech, fs, speech_length):
        ...
        # tell BSRNN the actual sampling rate so BandSplit only processes
        # effective subbands (fs=None would zero-pad to 769 bins / 48 subbands
        # at every fs, inflating LSTM memory ~1.7x at low fs)
        self.dnn.current_fs = int(fs)
